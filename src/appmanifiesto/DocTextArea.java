...
public class DocTextArea extends JTextPane {
	...
	public DocTextArea () {
		...
		addListeners ();
		setFocusNavigation ();
		//setLineWrap (true); // Enable word wrapping
		...
		StyleConstants.setFontSize (attributeSet, 10); // Set the font size
	...
	public void setParameters (int maxLines, int maxChars, String fontSizeName, String alignName) {
		...
		changeAlignment (alignName);
	}

	public void changeFontSize (String fontSizeName) {
		this.fontSizeName = fontSizeName;
		int fontSize = 10;
	...
	public void changeAlignment (String alignmentName) {
